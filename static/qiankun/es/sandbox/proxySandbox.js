  ...
  function ProxySandbox(name) {
    ...
    var proxy = new Proxy(fakeWindow, {
      ...
      get: function get(target, p) {
        ...
        if (p === 'document') {
          document[attachDocProxySymbol] = proxy; // remove the mark in next tick, thus we can identify whether it in micro app or not
          ...
          nextTick(function () {
            return delete document[attachDocProxySymbol];
          });
          return document;
