...
var dynamicStyleSheetElementsCache = {};
...
export default function patch(appName, appWrapperGetter, proxy) {
  ...
  if (mounting) {
    dynamicStyleSheetElements = dynamicStyleSheetElementsCache[appName] || [];
  } else {
  ...
  return function free() {
    ...
    console.log(`${appName} ready to rebuild!`);
    console.log({ dynamicStyleSheetElements });
    if (mounting) {
      dynamicStyleSheetElementsCache[appName] = dynamicStyleSheetElements;
    }
