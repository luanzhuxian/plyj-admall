  ...
  <ul class="sort">
    ...
    >
      ...
      <div class="direction">
        <pl-svg
          v-if="item.ovonic"
          class="icon icon-paixujiantoushang"
          name="icon-paixujiantoushang"
          :fill="value === item.ovonicValue.ascending? '#598BF8' : '#666'"
          width="6"
        />
        <pl-svg
          :class="{
            icon: true,
            'icon-paixujiantouxia': true,
            ovonic: item.ovonic
          }"
          name="icon-paixujiantoushang"
          :fill="((item.ovonic && value === item.ovonicValue.descending) || value === item.value)? '#598BF8' : '#666'"
          width="6"
        />
      </div>
    </li>
