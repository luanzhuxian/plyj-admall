...
import { requestDB, closeDB, getStore, addData, update, getData } from '../../assets/js/indexedDB'
let db
/**
 * 根据父级id从数据库查找城市列表
...
function getListFromIndexed (parentCode) {
  return new Promise((resolve, reject) => {
    try {
      const DBIndex = getStore(db, 'cities', 'locationCode', 'parentCode', 'parentCode').index('parentCode')
