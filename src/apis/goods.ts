 ...
 * 批量修改单个商品分类
 */
export const mendSingleCategory = () => axios.put('/apis/v1/product/category/sequenceNbr')
...
// 运费模板
// 获取模板数据
export const getTemplate = params => axios.get('/apis/v1/product/shippingTemplate/page', { params })

// 获取模板数据
export const getTemplateDetail = id => axios.get(`/apis/v1/product/shippingTemplate/${ id }`)

// 获取省（仅限一级地址）
export const getCity = params => axios.get('/apis/v1/systemctl/location/provinces', { params })

// 新增模板数据
export const addTemplate = data => axios.post('/apis/v1/product/shippingTemplate/add', data)

// 编辑模板数据
export const editTemplate = data => axios.post('/apis/v1/product/shippingTemplate/edit', data)

// 删除模板数据
export const deleteTemplate = id => axios.delete(`/apis/v1/product/shippingTemplate/delete/${ id }`)
