 ...
 * @returns {Promise<AxiosResponse<T>>}
 */
export const getRoomStatus = roomId => axios.get(`/apis/v1/mall/live/room/statue?roomId=${roomId}`)
/**
 * 查询房间最近2分钟实时统计人数
 * @returns {Promise<AxiosResponse<T>>}
 */
 ...
 * 营销中心 => 导出观看详情数据
 */
export const exportWatchDetail = (id, params) =>
  axios.post(`/apis/v1/mall/live/activity/${id}/export`, null, {
    responseType: 'blob',
    timeout: 0,
    params
  })
