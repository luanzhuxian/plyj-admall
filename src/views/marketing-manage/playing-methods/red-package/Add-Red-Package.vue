...
export default class AddRedPackage extends Vue {
    ...
    getBrief () {
        ...
        if (!this.form.redPacketCouponDTO.useStackable) {
            ...
            stackable = `可与其他${ this.form.redPacketCouponDTO.useWithCoupon ? '满减券/品类全' : '' }${ this.form.redPacketCouponDTO.useWithCoupon && this.form.redPacketCouponDTO.scholarship ? '、' : '' }${ this.form.redPacketCouponDTO.scholarship ? '奖学金' : '' }同时使用`
        }
