                ...
                <template slot-scope="{ row }">
                    <Operating>
                        <template slot="button-box">
                            ...
                            <a
                                @click="$router.push({name: 'LongmenLotteryData', params: {id : row.id},query: {status: row.status}})"
                            >
                                数据
                            </a>
                            <a
...
export default {
    ...
    methods: {
        ...
        share (row) {
            this.shareText = `${ this.$store.getters.mallUrl }/longmen-festival/lottery/${ row.id }`
            this.showShare = true
        }
    }
}
